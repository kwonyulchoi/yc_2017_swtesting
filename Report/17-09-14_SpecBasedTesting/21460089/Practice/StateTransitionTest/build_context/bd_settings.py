...
def Get_Module_ID():
    return [ 'StateTransitionTest','Practice/']
  ...
  return [
      ['x64_Linux_ubuntu',
        [
            ...
            [ 'bin_file',[
                ['out/x64_Linux_ubuntu/lib/libStateTransitionTest.so','lib'],
                ]
              ],
            [ 'lib_path',['out/x64_Linux_ubuntu/lib'] ],
        ]
      ...
      ['x64_Windows', 
        [
            ...
            [ 'bin_file',[
                  ['out/x64_Windows/lib/StateTransitionTest.dll','lib'],
                ] 
              ],
            [ 'lib_path',['out/x64_Windows/lib'] ],
        ]
